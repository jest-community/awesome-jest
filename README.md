...
- [jest-angular-test-verifier](https://www.npmjs.com/package/jest-angular-test-verifier) Ensures that essential Angular files have corresponding test files, reporting any missed opportunities and celebrating when all is well.
- [jest-slow-test-highlighter](https://www.npmjs.com/package/jest-slow-test-highlighter) Highlights and reports the slowest tests in your suite, helping you identify areas for performance optimization.
